...
cool_down = 0.1, --发射间隔
chargeTime = 0, --充能时间
heat_per_shot = 1, --单次发射的热量
heat_radiating = 5,
fire_count = 1, --单次发射的子弹量
fire_offset = 0, --子弹的旋转偏移（可模拟子弹不精确，或随机子弹角度）

autoFire = true, --自动开火
autoFireRange =  300, --自动开火范围

autoTarget = true, --自动寻的(武器自转)
target_type = "missile", --寻的类型 ship/bullet/all
rotSpeed = Pi,--旋转速度 弧度/s
rotLimit = Pi, --单侧旋转角度限制


bullet = obj.others.laser, --放出子弹类型 bullet/missile/decoy(分散放出型，诱使武器自爆)
struct = 1,
scale = 10 ,--子弹碰撞大小
activeTime = 0.2, --子弹存活时间
