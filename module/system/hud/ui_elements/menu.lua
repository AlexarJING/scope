...
function menu:init(ui)
	...
	self.windows = {
	selfcheck = require(root.."selfcheck"):init(ui,menu),
	stockage = require(root.."stockage"):init(ui,menu),
	message = require(root.."message"):init(ui,menu),
	logbook = require(root.."logbook"):init(ui,menu),
	exchange = require(root.."exchange"):init(ui,menu),
	dockyard = require(root.."dockyard"):init(ui,menu),
	}
